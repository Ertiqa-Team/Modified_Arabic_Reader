...
public final class SQLiteBooksDatabase extends BooksDatabase {
	...
	private void createTables() {
		...
		myDatabase.execSQL(
				"CREATE TABLE IF NOT EXISTS BooksHilights(" +
					"book_id TEXT NOT NULL," +
					"start_par_index INTEGER NOT NULL," +
					"start_elem_index INTEGER NOT NULL," +
					"start_char_index INTEGER NOT NULL," +
					"end_par_index INTEGER NOT NULL," +
					"end_elem_index INTEGER NOT NULL," +
