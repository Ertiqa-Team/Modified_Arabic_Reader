...
public class ZLTextBaseStyle extends ZLTextStyle {
	...
	public final ZLIntegerRangeOption AlignmentOption =
		new ZLIntegerRangeOption(GROUP, "Base:alignment", 1, 4, ZLTextAlignmentType.ALIGN_RIGHT);
	...
	public ZLTextBaseStyle(String fontFamily, int fontSize) {
		...
		FontSizeOption = new ZLIntegerRangeOption(GROUP, "Base:fontSize", 5, 72, fontSize+8);
	}
